...
Некоторые UX-фичи (например, persistence корзины или wishlist) **не реализованы намеренно**, чтобы сфокусироваться на:
...
Ниже представлен roadmap, демонстрирующий вектор развития production-продукта.
