...
[🔗 Live Demo](https://clothing-store-y2qw.vercel.app/?gender=female) | [🏗 Database Schema](#схема-базы-данных-er-диаграмма) | 
[🛠 Качество и CI/CD](#-качество-и-cicd)
...
**🔄 Процессы и надёжность**

- CI/CD & Automation
- CI (GitHub Actions): Автоматическая проверка типов, линтинг и верификация сборки при каждом Push/PR.
- CD (Vercel): Автоматический деплой production-веток и создание Preview-окружений для каждой фичи.
- Git Hooks (Husky + lint-staged): Гарантия чистоты кода на этапе коммита.
  **Тестирование**
- Unit-тесты: Валидация критической бизнес-логики и сервисов.
- E2E (Playwright): Тестирование полного цикла заказа и процесса оплаты.
